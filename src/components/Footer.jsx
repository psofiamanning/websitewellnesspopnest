        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/90 font-body text-sm leading-relaxed mb-4">
              ...
              Yoga, meditación y bienestar en el corazón de la ciudad.
            </p>
            {/* Redes sociales */}
            <div className="flex gap-4">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61581666718201"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-white/80 transition-colors duration-200"
                aria-label="Facebook"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a 
                  href="https://wa.me/525554379644" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-white/90 font-body text-sm hover:text-white transition-colors duration-200 flex items-center gap-2"
                >
              ...
              <li className="pt-2">
                <a
                  href="https://maps.app.goo.gl/G1GYTmrEAejHybBT8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-lg px-3 py-2 font-body text-sm font-semibold transition-transform duration-200 hover:scale-105"
                  style={{ backgroundColor: '#FFFFFF', color: '#B73D37' }}
                  aria-label="Déjanos tu reseña en Google"
                >
                  <span aria-hidden>⭐</span> Déjanos tu reseña en Google
                </a>
              </li>
            </ul>
          </div>
